...
function spreedlyMethod(spec) {
    ...
    return function () {
        ...
        return this.wrapTimeout(new Promise((function (resolve, reject) {
            for (var i = 0, l = urlParams.length; i < l; ++i) {
                ...
                if (!arg) {
                    ...
                    return reject(new Error(
                      'Spreedly: Argument "' + urlParams[i] + '" required, but got: ' + arg +
            ...
            if (args.length) {
                var err = new Error('Spreedly: Unknown arguments (' + args + ').');
                return reject(err);
            }
