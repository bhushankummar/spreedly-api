...
var create = function () {
    spreedly.payment.create({
        ...
        console.log('response.transaction.payment_method.token', response.transaction.payment_method.token);


        spreedly.payment.update(response.transaction.payment_method.token, {
            'payment_method': {
                'first_name': 'Newfirst',
                'last_name': 'Newlast'
            }
